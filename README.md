...
- 📝 Captions are saved without timestamps, deduplication, minimum-length filtering, or text rewriting. Only whitespace cleanup and punctuation-based sentence boundaries are applied; decimal numbers remain intact.
